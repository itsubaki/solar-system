...
export const PLANETS: PlanetData[] = [
    ...
    },
    {
        ...
        rings: [
            {
                innerRadius: (60268 / 71492) * (66900 / 58232),
                outerRadius: (60268 / 71492) * (74510 / 58232),
                color: "#E0D7C6"
            },
            {
                innerRadius: (60268 / 71492) * (74658 / 58232),
                outerRadius: (60268 / 71492) * (92000 / 58232),
                color: "#E5D7B9"
            },
            {
                innerRadius: (60268 / 71492) * (92000 / 58232),
                outerRadius: (60268 / 71492) * (117580 / 58232),
                color: "#F4D59E"
            },
            {
                innerRadius: (60268 / 71492) * (122170 / 58232),
                outerRadius: (60268 / 71492) * (136775 / 58232),
                color: "#F4D59E"
            },
            {
                innerRadius: (60268 / 71492) * (140180 / 58232),
                outerRadius: (60268 / 71492) * (140680 / 58232),
                color: "#E3E3F7"
            },
        ],
        satellites: [
    ...
    },
    {
        ...
        rings: [
            {
                innerRadius: (25362 / 71492) * (51149 / 25362),
                outerRadius: (25362 / 71492) * (51710 / 25362),
                color: "#B5E3E3"
            },
            {
                innerRadius: (25362 / 71492) * (47176 / 25362),
                outerRadius: (25362 / 71492) * (47462 / 25362),
                color: "#A0C8C8"
            },
            {
                innerRadius: (25362 / 71492) * (45619 / 25362),
                outerRadius: (25362 / 71492) * (45929 / 25362),
                color: "#7FC7C7"
            },
            {
                innerRadius: (25362 / 71492) * (44718 / 25362),
                outerRadius: (25362 / 71492) * (44918 / 25362),
                color: "#E3D7F7"
            },
            {
                innerRadius: (25362 / 71492) * (41837 / 25362),
                outerRadius: (25362 / 71492) * (42067 / 25362),
                color: "#D7F7E3"
            },
            {
                innerRadius: (25362 / 71492) * (41837 / 25362),
                outerRadius: (25362 / 71492) * (41939 / 25362),
                color: "#F7E3D7"
            },
            {
                innerRadius: (25362 / 71492) * (41939 / 25362),
                outerRadius: (25362 / 71492) * (42067 / 25362),
                color: "#E3F7D7"
            },
            {
                innerRadius: (25362 / 71492) * (42067 / 25362),
                outerRadius: (25362 / 71492) * (42190 / 25362),
                color: "#D7E3F7"
            }
        ],
