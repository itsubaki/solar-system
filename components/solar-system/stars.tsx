...
const ANDROMEDA_RIGHT_ASCENSION = 10.68479
const ANDROMEDA_DECLINATION = 41.26906
const ANDROMEDA_POSITION_ANGLE = 35
const ORION_NEBULA_RIGHT_ASCENSION = 83.8201
const ORION_NEBULA_DECLINATION = -5.3876
const LARGE_MAGELLANIC_CLOUD_RIGHT_ASCENSION = 80.89417
const LARGE_MAGELLANIC_CLOUD_DECLINATION = -69.75611
const SMALL_MAGELLANIC_CLOUD_RIGHT_ASCENSION = 13.18667
const SMALL_MAGELLANIC_CLOUD_DECLINATION = -72.82861
const PLEIADES_RIGHT_ASCENSION = 56.6583
const PLEIADES_DECLINATION = 24.1781
const HYADES_RIGHT_ASCENSION = 67.6142
const HYADES_DECLINATION = 16.7786
const OMEGA_CENTAURI_RIGHT_ASCENSION = 201.697
const OMEGA_CENTAURI_DECLINATION = -47.47947
const POLARIS_RIGHT_ASCENSION = 37.95456
const POLARIS_DECLINATION = 89.26411
